	...
	protected void service(HttpServletRequest request, HttpServletResponse responese)
			throws ServletException, IOException {
		     ...
		     if("".equals(pass1) || pass1==null || "".equals(pass2) || pass2==null){
		    	 ...
		    	 boolean b = memberService.regedit(memberlevel, memberName, loginName, pass1, phone, address, zip, email);
		          if(b==true){
		        	  System.out.println("添加成功");
		        	  //responese.getWriter().write("<font color = 'green'>success</font>");
		         // request.setAttribute("info","欢迎你" );
		         HttpSession session = request.getSession();
		         session.setAttribute("info", "欢迎你");
		         
		         request.getRequestDispatcher("success.jsp").forward(request,responese);
		        // responese.sendRedirect("seccess.jps");
		          }else{
		        	  System.out.println("添加失败");
		        	  responese.getWriter().write("<font color = 'red'>false</font>");
		          }
		     }
